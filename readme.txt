...
3. Did you ignore any of the warnings or errors presented by the accessibility checker? If so, why does this not seem like an accessibility concern? If it's useful, you can consolidate your thoughts on multiple warnings/errors if the rationale is similar.
    ...
    I ignored the error for surroundSoundValidation2 because I want to keep the headings the way they are because I learned that it is better to have "problem" small, then write the actual problem in large text underneath.
    I also ignored the warning for surroundSoundValidation because I wanted to create a button in a new section with out a heading for it, for a cleaner look.
